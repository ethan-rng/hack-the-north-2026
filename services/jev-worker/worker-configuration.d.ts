/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4baecd3f19b17ef9e429651fdf2bd028)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JEV_API_KEY">> {}
}
