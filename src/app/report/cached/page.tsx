  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-8">
      <div className="mb-4 rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800">
        Cached demo run — loaded from <code>public/demo/cached-run.json</code>. Independent of live Jev / Anthropic APIs.
      </div>
      <div className="mb-6">
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <MetricCard label="Avg wait" baseline={b.avg_wait_min.toFixed(1)} whatIf={w.avg_wait_min.toFixed(1)} delta={signed(w.avg_wait_min - b.avg_wait_min, 1)} good={w.avg_wait_min <= b.avg_wait_min} />
      </div>
