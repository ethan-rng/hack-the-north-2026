...
// Muted, warm-neutral stops keep the scene aligned with the paper-like UI.
const DAYLIGHT_STOPS: DaylightStop[] = [
  {
    at: 0,
    top: { r: 226, g: 215, b: 211 },
    bottom: { r: 244, g: 235, b: 222 },
  },
  {
    at: 0.2,
    top: { r: 238, g: 237, b: 228 },
    bottom: { r: 248, g: 246, b: 239 },
  },
  {
    at: 0.5,
    top: { r: 226, g: 230, b: 225 },
    bottom: { r: 242, g: 239, b: 229 },
  },
  {
    at: 0.76,
    top: { r: 207, g: 198, b: 202 },
    bottom: { r: 232, g: 215, b: 202 },
  },
  {
    at: 1,
    top: { r: 48, g: 53, b: 64 },
    bottom: { r: 65, g: 65, b: 72 },
  },
];
...
export function daylightBackgroundForProgress(
  ...
  const nextIndex = DAYLIGHT_STOPS.findIndex(
    (stop) => stop.at >= normalizedProgress,
  );
  if (nextIndex <= 0) return colorsOf(DAYLIGHT_STOPS[0]);

  const next = DAYLIGHT_STOPS[nextIndex];
  const previous = DAYLIGHT_STOPS[nextIndex - 1];
  const amount =
    (normalizedProgress - previous.at) / (next.at - previous.at);
