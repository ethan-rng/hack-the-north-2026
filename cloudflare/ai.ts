      ...
      "typesafe/jev",
      {
        ...
        questions: {
          action: {
            type: "choice",
            instructions:
              "Choose this individual's next action from valid choices. Fulfill unfinished personal goals using the provided targets and capabilities: move to a place before joining its service or purchasing there. If hungry, buy food then eat. Respect budget, interests, patience, known events, and planned departure; leave when goals are completed or departure is near. Keep productive queues/services unless a reason to leave arises. Do not browse repeatedly without progress. Perceived threats may justify fleeing, but choices depend on this person's traits. All submitted events are globally known; individual reactions still depend on goals and traits.",
